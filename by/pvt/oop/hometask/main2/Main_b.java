...
public class Main_b {
	...
	public static void main(String[] args) {
		...
		customer[4] = new Customer(5, "Васьков", "Василий", "Васильевич", "Алабама", "64738734", 5678, 5410008);
		customer[5] = new Customer(6, "Оринджон", "Калив", "Абдурахманыч", "Батуми", "75638756", 5676, 5410009);
		int a = 5670;
		int b = 5675;
		for (int i = 0; i < customer.length; i++) {
			if ((customer[i].getCreditKart() > a) && (customer[i].getCreditKart() < b)) {
