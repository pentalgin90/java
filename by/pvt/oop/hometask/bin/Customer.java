...
public class Customer extends Human implements Comparable<Customer>{
	...
	public int hashCode() {
		...
		result = prime * result + (int) (creditKart ^ (creditKart >>> 32));
		return result;
	}
	...
	public String toString() {
		return "Customer [id=" + getId() + ", surname=" + getSurname() + ", name=" + getName() + ", ochestvo=" + getOchestvo() + ", adres=" + getAdres() + ", telephone=" + getTelephone() + ", creditKart=" + creditKart + ", chetBanck=" + chetBanck + "]";
	}
